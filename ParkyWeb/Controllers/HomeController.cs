...
namespace ParkyWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, INationalParkRepository npRepository, ITrailsRepository trailsRepository
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                nationalParks = await _npRepository.GetAllAsync(SD.NationalParkAPIPath, HttpContext.Session.GetString("JWToken")),
                trails = await _trailsRepository.GetAllAsync(SD.TrailAPIPath, HttpContext.Session.GetString("JWToken"))
            };
